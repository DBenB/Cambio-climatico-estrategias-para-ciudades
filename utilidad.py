...
# Last Modified: 2026-01-19 09:07:47
# ---------------------------------------------
import random
...
class Ciudad:
    ...
    def beneficio(self, c):
            return c.delta * (1 - self.E_i/c.E_max ) + self.coop
    def costo(self, c):
            return c._lambda * (1 - self.T_i/c.T_max)
    def utilidad(self,c):
            B_i = self.beneficio(c)
            C_i = self.costo(c)
            return c.alpha*B_i-c.beta*C_i-c.gamma*self.R_i
